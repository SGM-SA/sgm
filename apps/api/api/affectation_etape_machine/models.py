...
class AffectationMachine(models.Model):
    ...
    machine = models.ForeignKey(Machine, null=False, default=False, on_delete=models.CASCADE)

    salarie = models.ForeignKey(Salarie, null=True, blank=True, on_delete=models.CASCADE)
